...
// Task artifacts-related helpers for the JvmCompilationTask protocol buffer
...
internal const val SOURCE_JARS_DIR = "_srcjars"
...
internal val Directories.stubs
  get() =
    Files
      .createDirectories(
        Paths
...
internal val Directories.incrementalData
  get() =
    Files
      .createDirectories(
        Paths
...
/**
 * Only keep java and kotlin files for the iterator. Filter out all other non-compilable files.
 */
private fun Iterator<String>.filterOutNonCompilableSources(): Iterator<String> =
  asSequence().filter { it.endsWith(".kt") || it.endsWith(".java") }.iterator()
